...
redBox1 = createSprite(width/2-100,610,20,100);
...
redBox3.shapeColor = color(255,0,0);
	...
	redBox1 = Bodies.rectangle(width/2-100,610,20,100,{isStatic:true});
	 ...
	 redBox2 = Bodies.rectangle(width/2,650,200,20,{isStatic:true});
	 World.add(world,redBox2);
	 redBox3 = Bodies.rectangle(width/2+100,610,20,100,{isStatic:true});
